...
import monitor.attribute.parser.FileConfParser;
import monitor.attribute.parser.IParser;
import monitor.attribute.parser.JmxConfParser;
...
public class MonitorController {
    ...
    public void updateSource(ActionEvent actionEvent) {
        ...
        if (readFromFile) {
            ...
            try {
                prop.load(inStream);
                String url = prop.getProperty("jmxUrl");
